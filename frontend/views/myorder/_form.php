...
$usey = ArrayHelper::map(User::find()->all(), 'id', 'username');
?>
    
<div class="container-fluid carrt myorder-form">
...
<?= $form->field($model, 'userId')->dropDownList($usey) ?>
   ...
   <?= $form->field($model, 'paymentMethod')->dropDownList([ 'Mpesa' => 'Mpesa', 'Credit Card' => 'Credit Card', '' => '', ], ['prompt' => '']) ?>
